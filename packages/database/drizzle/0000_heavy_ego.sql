CREATE TYPE "public"."connected_account_provider" AS ENUM('google');--> statement-breakpoint
CREATE TYPE "public"."connected_account_status" AS ENUM('active', 'reauth_required', 'revoked');--> statement-breakpoint
...
ALTER TABLE "connected_accounts" ADD CONSTRAINT "connected_accounts_corsair_account_id_corsair_accounts_id_fk" FOREIGN KEY ("corsair_account_id") REFERENCES "public"."corsair_accounts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "connected_accounts_provider_account_idx" ON "connected_accounts" USING btree ("provider","provider_account_id");--> statement-breakpoint
CREATE UNIQUE INDEX "connected_accounts_corsair_account_idx" ON "connected_accounts" USING btree ("corsair_account_id");--> statement-breakpoint
